...
Thank you for registering for EEE 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@eeeconference.com. You can find the copyright form here: www.eeeconference.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for EEE'18";

$your_headers = "From: EEE'18 <" . $my_email . ">";
...
<title>EEE'18 - Registration Form Filled!</title>
...
<br><p class="body" style="text-align:center!important; color: #FFF!important;">EEE'18 is part of the <b>4<sup>th</sup> World Congress on Electrical Engineering and Computer Systems and Science (EECSS'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://2018.eecss.org/" class="body-link">www.2018.eecss.org</a>.</p>
        </div>
        </div> 
      </div>
    </div>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">EEE 2018:</p>
      <p class="body">EEE 2018 will  be held in Madrid, Spain on August 21 - 23, 2018.</p>
     ...
     <!--  <p class="bold">Deadline Extension:</p>
      ...
      <p class="body">As per popular request, the organizing committee has decided to extend the EECSS'18 congress to three days (now August 21 - 23, 2018). The new high-level schedule is as follows:</p>
       ...
       <ul>
        <li><b>June 4th Day 1</b>: <BR>Registration</li>
        <li><b>June 5th Day 2</b>: <BR>Main Track Conference Sessions and Workshop(s)</li>
        <li><b>June 6th Day 3</b>: <BR>Main Track Conference Sessions and Gala dinner or Cruise tour</li>
      </ul>
      
      <p class="body">Registration for the workshop will be 122 EURs (VAT included) and separate from the main conferences. Workshop attendees will receive a certific. For registration, please visit: <a href="../registration" class="body-link">here</a>.</p>

      <p class="body">The workshop is included in the conference registration fee.</p>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at EEE'18!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LdkTv8SAAAAAHN-TAv9sO-H5ulyr2lAXhH1zO-X"></div></center>
  <div class="cf">
